...
const SearchBar = () => {
    ...
    const { titleBoost, contentBoost, tagsBoost, parentCategoriesBoost, indexDocSidebarParentCategories, maxSearchResults, } = usePluginData("@anmode/docusaurus-search-local");
